    ...
    <div className="max-w-sm">
      ...
      <Card variant="solid" className="p-6">
        <form action={formAction}>
          <label htmlFor="current-password" className="mb-1 block text-sm font-semibold text-brand-navy">Contraseña actual</label>
          <input
            id="current-password"
            type="password"
          ...
          />
          <label htmlFor="new-password" className="mb-1 block text-sm font-semibold text-brand-navy">Nueva contraseña</label>
          <input
            id="new-password"
            type="password"
            name="newPassword"
